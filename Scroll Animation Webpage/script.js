...
let appleDiv = document.getElementById('apple-div');
...
function changeText(){
	...
	// Map vertical scroll position to the horizontal position of the Apple
	appleDiv.style.left = pos / (height * 4) * width + 'px';
